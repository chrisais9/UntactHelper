package kr.koohyongmo.untacthelper.calendar.Utils;
...
public final class CalendarUtils {
     ...
     */
    public static Drawable getDrawableText(Context context, String text, Typeface typeface, int backgroundcolor, int textcolor, int size) {
